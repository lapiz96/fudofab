...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="tml-section" ref={sectionRef}>
      {/* Decorative Lottie orb */}
      <div className="tml-lottie-bg" aria-hidden>
        <LottiePlayer
          src=""
          loop autoplay
      ...
      <div className="tml-glow-left" />
      <div className="tml-glow-right" />

      <div className="section-container" style={{ position:'relative', zIndex:1 }}>
        {/* Header */}
        <div className="tml-header reveal-up">
        ...
        {/* Bottom CTA */}
        <div className="tml-cta-wrap reveal-up">
